...
import com.hellow.projectmanagerapp.databinding.ItemTaskBinding
...
open class TaskListItemsAdapter(
   ...
   class MyViewHolder(itemBinding: ItemTaskBinding) : RecyclerView.ViewHolder(itemBinding.root) {
